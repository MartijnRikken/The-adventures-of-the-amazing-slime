...
public class Hitbox4 extends CircleEntity implements hitbox {

    SlimeSprite slime;
    Tracker tracker;
    Health hp;
    protected Hitbox4(Coordinate2D initialLocation, Tracker tracker, SlimeSprite slime, Health hp) {
    ...
    public void onCollision(Collider collider) {
        if (tracker.hitbox4 == false) {

            if (tracker.hitbox1 == true && tracker.hitbox2 == true && tracker.hitbox3 == true) {
                tracker.hitbox4 = true;
